...
# Plot figure: Model restfact_targethill1 - Restoration method
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
ggplot(data_model_targethill1, aes(x = rest.meth, y = target.hill.1)) +
...
ggsave("outputs/figures/plants_species_diversity/model_restfact_targethill1_restmeth_emm_se.jpg",
