...
# Plot figure: Model restfact_forbindex - Restoration method
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
load(file = here("outputs", "models", "vegetation", "model_plants_restfact_forbindex.Rdata"))
...
ggplot(data_model_forbindex, aes(x = rest.meth, y = forb.index)) +
  ...
  geom_text(data = cld_results, aes(x = rest.meth, y = 20, label = .group),          # Add compact letters
...
ggsave("outputs/figures/plants_species_diversity/model_restfact_forbindex_restmeth_emm_se.jpg",
