...
## load data
load(file = here("outputs", "models", "model_plants_restfact_tothill0.Rdata"))
...
## load data
load(file = here("outputs", "models", "model_plants_restfact_targethill0.Rdata"))
...
## load data
load(file = here("outputs", "models", "model_plants_restfact_tothill1.Rdata"))
...
## load data
load(file = here("outputs", "models", "model_plants_restfact_targethill1.Rdata"))
...
## load data
load(file = here("outputs", "models", "model_plants_restfact_fcsihill0.Rdata"))
...
## load data
load(file = here("outputs", "models", "model_plants_restfact_fgratio.Rdata"))
