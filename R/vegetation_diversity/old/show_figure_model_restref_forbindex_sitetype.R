...
# Plot figure: Model restref_forbindex - Site type
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
# negative      1.06 0.256 Inf
# restored      4.32 0.869 Inf
# positive      5.35 1.275 Inf

# compact letter display
cld_results <- multcomp::cld(emm.site.type, adjust = "tukey", Letters = letters)

# plot with EMMs and SE
plot1 <- ggplot(data_model_forbindex, aes(x = site.type, y = forb.index)) +
  ...
  geom_text(data = cld_results, aes(x = site.type, y = 20, label = .group),          # Add compact letters
            vjust = -0.5, color = "black", size = 4) +
  labs(x = NULL, y = "Forbindex") +
...
ggsave("outputs/figures/plants_species_diversity/model_restref_forbindex_sitetype_emm_se.jpg",
