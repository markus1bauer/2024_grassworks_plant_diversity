...
# land.use.hist
int_model <- glm(fcsi.hill.0 ~ rest.meth * land.use.hist, data = data_all)
anova(int_model)
# no interaction

# rest.age
int_model <- glm(fcsi.hill.0 ~ rest.meth * rest.age, data = data_all)
anova(int_model)
# no interaction

# region
int_model <- glm(fcsi.hill.0 ~ rest.meth * region, data = data_all)
anova(int_model)
# no interaction

# hydrology
int_model <- glm(fcsi.hill.0 ~ rest.meth * hydrology, data = data_all)
anova(int_model)
# interaction
...
# rest.age
int_model <- glm(fcsi.hill.0 ~ land.use.hist * rest.age, data = data_all)
anova(int_model)
# no interaction 

# region
int_model <- glm(fcsi.hill.0 ~ land.use.hist * region, data = data_all)
anova(int_model)
# no interaction

# hydrology
int_model <- glm(fcsi.hill.0 ~ land.use.hist * hydrology, data = data_all)
anova(int_model)
# no interaction
...
# region
int_model <- glm(fcsi.hill.0 ~ rest.age * region, data = data_all)
anova(int_model)
# interaction

# hydrology
int_model <- glm(fcsi.hill.0 ~ rest.age * hydrology, data = data_all)
anova(int_model)
# interaction
...
# hydrology
int_model <- glm(fcsi.hill.0 ~ region * hydrology, data = data_all)
anova(int_model)
# interaction
...
restfact_fcsihill0_20y <- glmmTMB(
  fcsi.hill.0 ~ rest.meth + land.use.hist + rest.age.std
  + (1 |region) + (1 |hydrology),
