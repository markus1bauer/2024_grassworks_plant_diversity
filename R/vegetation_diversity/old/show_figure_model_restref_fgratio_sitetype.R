...
# Plot figure: Model restref_fgratio - Site type
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
# negative     0.356 0.0914 Inf
# restored     1.094 0.2418 Inf
# positive     1.135 0.2886 Inf

# compact letter display
cld_results <- multcomp::cld(emm.site.type, adjust = "tukey", Letters = letters)

# plot with EMMs and SE
plot1 <- ggplot(data_model_fgratio, aes(x = site.type, y = fg.ratio)) +
  ...
  geom_text(data = cld_results, aes(x = site.type, y = 5, label = .group),          # Add compact letters
            vjust = -0.5, color = "black", size = 4) +
  labs(x = NULL, y = "Forb-grass ratio") +
...
ggsave("outputs/figures/plants_species_diversity/model_restref_fgratio_sitetype_emm_se.jpg",
